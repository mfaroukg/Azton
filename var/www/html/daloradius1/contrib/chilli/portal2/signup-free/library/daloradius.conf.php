...
$configValues['CONFIG_SIGNUP_MSG_TITLE'] = "We provide free registration service to our hotspots. <br/>".
					"Complete the form and click the Register button to generate a username and password.<br>
نوفر لك اشتراك مؤقت لنقطة اتصالنا اكمل المعلومات التالية بدقة واضغط زر الاشتراك وسوف تحصل على كلمة المرور الخاصة بك  ";
...
$configValues['CONFIG_SIGNUP_SUCCESS_MSG_LOGIN_LINK'] = "<br/>Click <b><a href='http://10.42.0.1:4990/www/login.chi'>here</a></b>".
...
$configValues['CONFIG_GROUP_NAME'] = "free";       /* the group name to add the user to */
